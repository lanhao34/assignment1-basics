...
def run_rope(
    ...
    """
    rope = mynn.RotaryPositionalEmbedding(theta, d_k, max_seq_len)
...
def run_rmsnorm(
    ...
    """
    rmsnorm = mynn.RMSNorm(d_model, eps)
...
def run_silu(in_features: Float[Tensor, " ..."]) -> Float[Tensor, " ..."]:
    ...
    """
    from cs336_basics.mynn import SiLU
...
def run_get_batch(
    ...
    """
    from cs336_basics.data_utils import DataLoader
...
def run_cross_entropy(
    ...
    """
    return mynn.CrossEntropyLoss()(inputs, targets)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    clipper = mynn.GradientClipper(max_l2_norm)
    clipper(parameters)
...
def run_get_lr_cosine_schedule(
    ...
    """
    lr_scheduler = mynn.LinearWarmupCosineAnnealingLR(warmup_iters, cosine_cycle_iters, max_learning_rate, min_learning_rate)
    return lr_scheduler.step(it)
...
def run_save_checkpoint(
    ...
    """
    from cs336_basics.data_utils import save_checkpoint
